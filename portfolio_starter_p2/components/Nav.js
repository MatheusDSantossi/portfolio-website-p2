...
const Nav = () => {
  ...
  return (
    ...
    bottom-0 mt-auto xl:right-[2%] z-50 w-full xl:w-16 xl:max-w-md xl:h-screen
    '>
    {/* Inner */}
          ...
          return (
            ...
            >
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                <div className='bg-white relative text-primary items-center 
                p-[6px] rounded-[3px]'>
                <div className='text-[12px] leading-none font-semibold capitalize'>
                  {link.name}
                </div>
                <div className='border border-solid border-l-white border-l-8 border-y-transparent border-y-[6px] border-r-0 absolute -right-2'></div>
                </div>
                {/* icon */}
              </div>
              <div>{link.icon}</div>
