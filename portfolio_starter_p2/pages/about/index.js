...
const About = () => {
  ...
  return (
    <div className='h-full bg-primary/30 py-32 text-center xl:text-left pt-40'>
      <Circles />
      {/* avatar img */}
      <motion.div
          ...
          <motion.div
            ...
            <div className='flex flex-1 xl:gap-x-6'>
              ...
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                ...
                <div className='text-xs uppercase tracking-[1´x] leading-[1.4] max-w-[100px]'>Years of experience</div>
              </div>
              {/* clients */}
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
                ...
                <div className='text-xs uppercase tracking-[1´x] leading-[1.4] max-w-[100px]'>Satisfied clients</div>
              </div>
              {/* projects */}
              <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0'>
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
                ...
                <div className='text-xs uppercase tracking-[1´x] leading-[1.4] max-w-[100px]'>Finished projects</div>
              </div>
              {/* awards */}
              <div className='relative flex-1 '>
                ...
                <div className='text-xs uppercase tracking-[1´x] leading-[1.4] max-w-[100px]'>Winning awards</div>
              </div>
            </div>
          </motion.div>
        </div>
